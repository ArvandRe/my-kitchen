...
- Редактирование существующего рецепта: выбор из списка → тот же пошаговый диалог, что и при добавлении.
...
| `/edit` | Выбрать рецепт из списка и отредактировать его в том же порядке, что и при `/add` |
...
| `/cancel` | Отменить текущее добавление или редактирование рецепта |
...
└── app/
    ...
    │   ├── edit_states.py       # состояния FSM для команды /edit
    ...
    └── handlers/
        ...
        ├── edit_recipe.py       # обработчик /edit
